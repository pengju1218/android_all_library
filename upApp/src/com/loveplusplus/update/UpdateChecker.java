...
public class UpdateChecker extends Fragment {
    ...
    protected void sendPost(String urlStr) {
        HttpTask httpTask = new HttpTask();
        httpTask.execute(urlStr);
...
/*
    ...
    public void showDialog(String content, final String apkUrl) {
        //  MyDialog dialogCustom = new MyDialog(mContext, R.style.DialogActivityTheme);

        AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
        builder.setTitle("更新提示").setMessage(content)
    ...
    private void goToDownload(String apkUrl) {
